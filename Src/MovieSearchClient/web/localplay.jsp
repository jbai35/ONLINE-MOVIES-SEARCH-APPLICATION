...
<!--        <script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>-->
    ...
    <%
        List<Movies> movies = (List<Movies>) request.getAttribute("movieList");
    %>
	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a class="active" href="http://localhost:8080/MovieSearchClient/MovieList">LOCAL</a></li>
		...
		<div id="sub-navigation">
			...
			<div id="search">
				<form action="http://localhost:8080/MovieSearchClient/SearchByTitle" method="POST">
		...
		<p class="text-right"><a href="#">See all</a></p>             
                ...
                <!-- container -->									
                                <% for (int i = 0; i < movies.size(); i++) {
                                        ...
                                        String writer = movies.get(i).getWriter();
                                        String stars = movies.get(i).getStars();
                                        String genres = movies.get(i).getGenres();
                                        String plot = movies.get(i).getPlot();
                                        double rating = movies.get(i).getRating();
                                        System.out.println("change vedio:"+vedioURL);
                                %>
                                <hr/>
                                <div class="info">                                  
                                    <a href="#"><img hspace="30" src="<%=imgURL%>" style="float:left"/></a>
                                    <u1 class="list" float:right>
                                        <h4 style = "margin:20px"><font size="5"> <%= movies.get(i).getTitle()%> </font></h4>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Year: </b></font> <font size="3" color="white"><%= movies.get(i).getDate()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Director: </b></font> <font size="3" color="white"><%= movies.get(i).getDirector()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Writer: </b></font> <font size="3" color="white"><%= movies.get(i).getWriter()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Stars: </b></font> <font size="3" color="white"><%= movies.get(i).getStars()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Genres: </b></font> <font size="3" color="white"><%= movies.get(i).getGenres()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Plot: </b></font> <font size="3" color="white"><%= movies.get(i).getPlot()%></font></p>
                                        <p style = "margin:10px"><font size="4" color="#f3b12b"><b>Rating: </b></font> <font size="3" color="white"><%= movies.get(i).getRating()%></font></p>
